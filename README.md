# Mobile Checkout Optimization: Revenue Recovery Project
**Project Lead:** Snigdha Nath  
**Tools:** Excel (Data Analytics) | Jira (Agile/Kanban) | Confluence (Stakeholder Documentation)

## 📊 Executive Summary
This project identifies a critical technical barrier within the mobile checkout funnel. Through deep-dive data analysis, a **70% transaction failure rate** was discovered specifically for mobile users. This resulted in an estimated revenue loss of **€504.00 per week**. I initiated a technical remediation plan via Jira to recover approximately **€2,016 in monthly revenue**.

## 📈 1. Data-Driven Insights (Excel)
